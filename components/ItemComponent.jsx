...
export default function ItemComponent() {
    ...
    return (
        <div className='bg-gray-600 grid grid-cols-1 md:grid-cols-2 '>
            ...
            <div style={{ backgroundImage: "url(" + iphone + ")", backgroundRepeat: 'no-repeat' }} className='-ml-[40%] -mr-[40%] md:ml-0 scale-50 -mt-20 border'>
            ...
            <div className='grid grid-cols-3 md:grid-cols-2 -mt-20 mx-10'>
